...
class Credential:
	...
	def __init__ (self,username,platform_name,account_name,password):
		'''
		Method to define the properties for each user's account object
		'''
	...
	def save_credentials(self):
		'''
		method to save the user's entered credentials
		'''
	...
	def delete_credentials(self):
		'''
		Method to help deleting the saved credentials if needed
		'''
	...
	def generate_password(size=8, char=string.ascii_lowercase+string.ascii_uppercase+string.digits):
		'''
		Method to generate a password for a user if needed.
		'''
